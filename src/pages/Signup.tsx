...
import { Video, Mail, Lock, UserPlus, AlertCircle, Chrome } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Join Lumina AI</h1>
          <p className="text-zinc-400">Start generating high-quality AI videos in seconds.</p>
        </div>
